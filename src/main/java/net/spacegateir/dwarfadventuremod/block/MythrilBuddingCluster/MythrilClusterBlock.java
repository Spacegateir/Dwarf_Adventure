...
public class MythrilClusterBlock extends MythrilBlock implements Waterloggable {
    ...
    public MythrilClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
