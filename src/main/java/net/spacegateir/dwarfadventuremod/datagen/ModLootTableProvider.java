...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.COURSE_DIRT_TRAP_BLOCK_SPIKES);
        addDrop(ModBlocks.STONE_TRAP_BLOCK);
        addDrop(ModBlocks.STONE_TRAP_BLOCK_SPIKES);
        addDrop(ModBlocks.DEEPSLATE_TRAP_BLOCK);
        addDrop(ModBlocks.DEEPSLATE_TRAP_BLOCK_SPIKES);
        ...
        addDrop(ModBlocks.SLOWNESS_BLOCK);
        addDrop(ModBlocks.ABSORBING_BLOCK);
        addDrop(ModBlocks.HUNGER_BLOCK);
        addDrop(ModBlocks.SATURATION_BLOCK);
        addDrop(ModBlocks.BAD_OMEN_BLOCK);
        addDrop(ModBlocks.BLINDNESS_BLOCK);
        addDrop(ModBlocks.CONDUIT_POWER_BLOCK);
        addDrop(ModBlocks.DARKNESS_BLOCK);
        addDrop(ModBlocks.DOLPHINS_GRACE_BLOCK);
        addDrop(ModBlocks.FIRE_RESISTANCE_BLOCK);
        addDrop(ModBlocks.GLOWING_BLOCK);
        addDrop(ModBlocks.HASTE_BLOCK);
        addDrop(ModBlocks.HERO_OF_THE_VILLAGE_BLOCK);
        addDrop(ModBlocks.INSTANT_DAMAGE_BLOCK);
        addDrop(ModBlocks.INVISIBILITY_BLOCK);
        addDrop(ModBlocks.JUMP_BOOST_BLOCK);
        addDrop(ModBlocks.LEVEITATION_BLOCK);
        addDrop(ModBlocks.LUCK_BLOCK);
        addDrop(ModBlocks.MINING_FATIGUE_BLOCK);
        addDrop(ModBlocks.NAUSEA_BLOCK);
        addDrop(ModBlocks.NIGHT_VISION_BLOCK);
        addDrop(ModBlocks.POISON_BLOCK);
        addDrop(ModBlocks.REGENERATION_BLOCK);
        addDrop(ModBlocks.RESISTANCE_BLOCK);
        addDrop(ModBlocks.SLOW_FALLING_BLOCK);
        addDrop(ModBlocks.STRENGTH_BLOCK);
        addDrop(ModBlocks.UNLUCK_BLOCK);
        addDrop(ModBlocks.WATER_BREATHING_BLOCK);
        addDrop(ModBlocks.WEAKNESS_BLOCK);
        addDrop(ModBlocks.WITHER_BLOCK);
        addDrop(ModBlocks.HEALTH_BOOST_BLOCK);
        addDrop(ModBlocks.INSTANT_HEALTH_BLOCK);

        addDrop(ModBlocks.STATUS_REMOVAL_BLOCK);
        addDrop(ModBlocks.STATUS_REMOVAL_NEUTRAL_BLOCK);
        addDrop(ModBlocks.STATUS_REMOVAL_NEGATIVE_BLOCK);
        addDrop(ModBlocks.STATUS_REMOVAL_POSITIVE_BLOCK);
        addDrop(ModBlocks.DISORIENT_BLOCK);
        addDrop(ModBlocks.STICKY_FEAT_BLOCK);
