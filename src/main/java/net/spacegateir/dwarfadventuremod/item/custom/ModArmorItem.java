...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.AER, new StatusEffectInstance(StatusEffects.SPEED, 400, 0))
                    .put(ModArmorMaterials.IGNIS, new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 0))
                    .put(ModArmorMaterials.AQUA, new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 400, 0))
                    .put(ModArmorMaterials.TERA, new StatusEffectInstance(StatusEffects.JUMP_BOOST, 400, 0))
                    .put(ModArmorMaterials.DWARF_GOLD, new StatusEffectInstance(StatusEffects.GLOWING, 400, 0))
