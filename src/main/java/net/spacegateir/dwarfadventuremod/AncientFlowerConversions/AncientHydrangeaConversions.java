...
public class AncientHydrangeaConversions {
    ...
    private static void addAllWool() {
        ...
        for (Item woolItem : woolItems) {
            CONVERSION_MAP.put(new ItemStack(woolItem), new ItemStack(Items.LIME_WOOL));
        }
    }
    private static void addAllCarpet() {
        ...
        for (Item CarpetItem : CarpetItems) {
            CONVERSION_MAP.put(new ItemStack(CarpetItem), new ItemStack(Items.LIME_CARPET));
        }
    }
    private static void addAllConcreate() {
        ...
        for (Item concreateItem : concreateItems) {
            CONVERSION_MAP.put(new ItemStack(concreateItem), new ItemStack(Items.LIME_CONCRETE));
        }
    }
    private static void addAllConcreatePowder() {
        ...
        for (Item concreatepowderItem : concreatepowderItems) {
            CONVERSION_MAP.put(new ItemStack(concreatepowderItem), new ItemStack(Items.LIME_CONCRETE_POWDER));
        }
    }
    private static void addAllTerracotta() {
        ...
        for (Item TerracottaItem : TerracottaItems) {
            CONVERSION_MAP.put(new ItemStack(TerracottaItem), new ItemStack(Items.LIME_TERRACOTTA));
        }
    }
    private static void addAllGlazedTerracotta() {
        ...
        for (Item GlazedTerracottaItem : GlazedTerracottaItems) {
            CONVERSION_MAP.put(new ItemStack(GlazedTerracottaItem), new ItemStack(Items.LIME_GLAZED_TERRACOTTA));
        }
    }
    private static void addAllStainedGlass() {
        ...
        for (Item StainedGlassItem : StainedGlassItems) {
            CONVERSION_MAP.put(new ItemStack(StainedGlassItem), new ItemStack(Items.LIME_STAINED_GLASS));
        }
    }
    private static void addAllStainedGlassPane() {
        ...
        for (Item StainedGlassPaneItem : StainedGlassPaneItems) {
            CONVERSION_MAP.put(new ItemStack(StainedGlassPaneItem), new ItemStack(Items.LIME_STAINED_GLASS_PANE));
        }
    }
    private static void addAllBed() {
        ...
        for (Item BedItem : BedItems) {
            CONVERSION_MAP.put(new ItemStack(BedItem), new ItemStack(Items.LIME_BED));
        }
    }
    private static void addAllCandle() {
        ...
        for (Item CandleItem : CandleItems) {
            CONVERSION_MAP.put(new ItemStack(CandleItem), new ItemStack(Items.LIME_CANDLE));
        }
    }
    ...
    public static void registerEvents() {
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (serverWorld.getBlockState(blockPos).getBlock() == ModBlocks.ANCIENT_HYDRANGEA_FLOWER_BLOCK) {
